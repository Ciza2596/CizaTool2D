...
namespace CizaTool2D.Converter {
    ...
    #region IAnimator
        ...
        public bool GetIsCurrentState_Name(int layer, string currentStateName) => throw new System.NotImplementedException();
        ...
        public void Play(int index, string stateName, bool loop, float timeScale) {
            //確認目前已播放想同動畫
            if (GetName (index) == stateName) return;
    
            //播放
            TrackEntry track = _skeletonAnimation.state.SetAnimation (index, stateName, loop);
